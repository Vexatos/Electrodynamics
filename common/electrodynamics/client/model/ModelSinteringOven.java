...
public class ModelSinteringOven extends ModelBase {
	...
	public ModelSinteringOven() {
		...
		hingeTop.setTextureSize(128, 128);
		...
		hingeBottom.setTextureSize(128, 128);
		...
		ovenBase.setTextureSize(128, 128);
		...
		ovenSupport.setTextureSize(128, 128);
		...
		ovenDoorTop.setTextureSize(128, 128);
		...
		ovenDoorBottom.setTextureSize(128, 128);
		...
		ovenDoorRight.setTextureSize(128, 128);
		...
		ovenDoorLeft.setTextureSize(128, 128);
		...
		ovenBottom.setTextureSize(128, 128);
		...
		ovenBack.setTextureSize(128, 128);
		...
		ovenLeft.setTextureSize(128, 128);
		...
		ovenRight.setTextureSize(128, 128);
		...
		ovenTop.setTextureSize(128, 128);
		ovenTop.mirror = true;
		...
		bottomRack.setTextureSize(128, 128);
		...
		ovenDoorGlass.setTextureSize(128, 128);
