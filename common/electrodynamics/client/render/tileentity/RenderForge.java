...
import electrodynamics.client.model.ModelForge;
...
public class RenderForge extends TileEntitySpecialRenderer {
	...
	public final ModelForge model;
	
	public RenderForge() {
		this.model = new ModelForge();
	}
	
	public void renderForge(TileEntityMachine tile, double x, double y, double z, float partial) {
		GL11.glPushMatrix();
	...
	public void renderTileEntityAt(TileEntity tileentity, double d0, double d1, double d2, float f) {
		renderForge((TileEntityMachine) tileentity, d0, d1, d2, f);
	}
